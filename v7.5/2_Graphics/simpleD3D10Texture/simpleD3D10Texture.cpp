...
int main(int argc, char *argv[])
{
    ...
    HWND hWnd = CreateWindow(wc.lpszClassName, "CUDA/D3D10 Texture InterOP",
        ...
        SUCCEEDED(InitTextures()))
    {
        ...
        cudaGraphicsD3D10RegisterResource(&g_texture_2d.cudaResource, g_texture_2d.pTexture, cudaGraphicsRegisterFlagsNone);
